class ViajeroFrecuente:
    ...
    def __str__(self):
        return 'NUMERO VIAJERO: {:4}  DNI: {:10} NOMBRE Y APELLIDO: {:10} {:10} MILLAS ACUMULADAS: {}.'.format(self.__numViajero, self.__dni, self.__nombre, self.__apellido, self.__millasAcumuladas)

    def totalMillas(self):
        return self.__millasAcumuladas

    def acumularMillas(self, masMillas):
        self.__millasAcumuladas += masMillas
        return self.__millasAcumuladas
